...
namespace nlsat {
    ...
    public:
        ...
        levelwise(nlsat::solver& solver, polynomial_ref_vector const& ps, var max_x, assignment const& s, pmanager& pm, anum_manager& am, polynomial::cache & cache, bool fully_linear=false);
        ~levelwise();
